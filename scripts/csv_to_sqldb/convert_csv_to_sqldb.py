...
dbresponse = db.run("SELECT submitter_name, COUNT(*) as issue_count FROM customersupport GROUP BY requester_name ORDER BY issue_count DESC LIMIT 10;")
